        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <div className="flex gap-3 mt-6">
                    <a href={`https://wa.me/${settings?.phone?.replace(/\D/g, '') || ''}`} target="_blank" rel="noopener" className="w-10 h-10 bg-[#25D366] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform">
                    ...
                    <a href="https://t.me/bmstroy" target="_blank" rel="noopener" className="w-10 h-10 bg-[#0088cc] rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
