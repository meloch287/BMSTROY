...
const FALLBACK_VIDEOS: Video[] = [
  { id: 1, title: 'Обзор ремонта в ЖК "Символ"', type: 'Обзор', thumb: '/uploads/1764611922746-1__4_.jpeg', url: 'https://www.youtube.com/embed/LXb3EKWsInQ', isYoutube: true },
  { id: 2, title: 'Отзыв: Ремонт двушки за 3 месяца', type: 'Отзыв', thumb: '/uploads/1764611959220-1__5_.jpeg', url: 'https://www.youtube.com/embed/dummy2', isYoutube: true },
  { id: 3, title: 'Как мы делаем шумоизоляцию', type: 'Технологии', thumb: '/uploads/1764613804512-1__5_.jpeg', url: 'https://www.youtube.com/embed/dummy3', isYoutube: true },
];

export default function VideoSection() {
  const [videos, setVideos] = useState<Video[]>(FALLBACK_VIDEOS);
  const [activeVideo, setActiveVideo] = useState<Video>(FALLBACK_VIDEOS[0]);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative aspect-video max-w-5xl mx-auto bg-black rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-white/10 group mb-12">
          {!isPlaying ? (
            <>
              <img 
                src={activeVideo.thumb || '/uploads/1764611922746-1__4_.jpeg'} 
                loading="lazy" 
                width={1280} 
                height={720} 
